...
$query = mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM forms
...
<form>
	<div class="form-row">
		...
		<div class="col-md-2 mb-3">
			<a href="add_form.php" class="btn btn-primary btn-block">New Form</a>
		</div>
	</div>
</form>
...
<div class="table-responsive">
	...
	<table class="table border">
		<thead class="thead-light">
			<tr>
				<th><a class="text-secondary" href="?<?php echo $url_query_strings_sb; ?>&sortby=form_name&order=<?php echo $order; ?>">Name</a></th>
				<th><a class="text-secondary" href="?<?php echo $url_query_strings_sb; ?>&sortby=form_created_at&order=<?php echo $order; ?>">Created</a></th>
		...
		<tbody>
			...
			<tr>	
				<td>
			 		<a href="edit_form.php?form_id=<?php echo $form_id; ?>">
			 			<?php echo $name; ?>
			 		</a>
			 	</td>
          ...
          <div class="dropdown dropleft text-center">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="edit_form.php?form_id=<?php echo $form_id; ?>">Edit</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item text-danger" href="post.php?delete_form=<?php echo $form_id; ?>" class="btn btn-outline-danger">Delete</a>
            </div>
          </div>
        </td>
			</tr>
